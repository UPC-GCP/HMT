...
public:
    ...
    // Functions
    double calcHarmonicMean(double dPF, std::vector<double> lambda, std::vector<double> deltaX); // Should remove this from here and keep it just as a local function
