...
int main(int argc, char* argv[]){
    ...
    /* ///// Medic ///// */
    /* /1* std::cout << "Initializing medic ...\n"; *1/ */
    /* /1* Medic Mdc(Msh, Prb); std::cout << "Diagnostic tools configured.\n"; *1/ */
    ...
    /*     // Diagnostics */
    /*     /1* Mdc.getDiagnostic(Mat, Msh, Dsc, cTemp, t); *1/ */
