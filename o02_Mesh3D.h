...
struct Matrix{
    double ap=0, aw=0, ae=0, as=0, an=0, ab=0, at=0;
};

struct MeshBase{
    int totNodes=1; std::vector<int> N{};
    std::vector<std::vector<double>> Faces{}, Nodes{}, deltaX{}, dX{}; // Coordinates, distances -> [axis][index]
...
struct boundVelocity{ // NEED TO MODIFY THIS FOR 3D
    int type{}, side{};
